<section id="minuman" class="flex flex-col gap-4 mt-[40px] pb-20">
        ...
        <div class="swiper w-full overflow-x-hidden">
            <div class="swiper-wrapper">
                @foreach ($menuMinumans as $menuMinuman)
                    <div class="swiper-slide !w-fit">
                        <a href="{{ route('menu.show', $menuMinuman->id) }}" class="card">
                            <div
                                ...
                                <div class="flex w-full h-[150px] shrink-0 rounded-[30px] bg-[#D9D9D9] overflow-hidden">
                                    <img src="{{ asset('storage/' . $menuMinuman->image) }}" class="w-full h-full object-cover"
                                        alt="thumbnail">
                                </div>
                                <div class="flex flex-col gap-3">
                                    ...
                                    <div class="flex items-center gap-[6px]">
                                        <img src="assets/images/icons/3dcube.svg" class="w-5 h-5 flex shrink-0"
                                            alt="icon">
                                        <p class="text-sm text-ngekos-grey">{{ $menuMinuman->category->name }}</p>
                                    </div>
                                    <p class="font-semibold text-lg text-ngekos-orange">Rp
                                        {{ number_format($menuMinuman->price, 0, ',', '.') }} <span
